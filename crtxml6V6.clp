...
CRTRPGMOD MODULE(XMLSERVICE/PLUGCONF6) SRCFILE(XMLSERVICE/QRPGLESRC) +
  DBGVIEW(*SOURCE) OUTPUT(*PRINT) REPLACE(*YES) +
  TGTRLS(V6R1M0)
...
CRTPGM PGM(ZENDSVR6/XMLSERVICE) +
...
CRTPGM PGM(ZENDSVR6/XMLVER) +
  MODULE(XMLSERVICE/XMLVER) +
         TGTRLS(V6R1M0)

CRTPGM PGM(ZENDSVR6/XMLCGI) +
...
DLTMOD MODULE(XMLSERVICE/PLUGCONF6)
