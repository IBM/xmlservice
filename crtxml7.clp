...
CRTRPGMOD MODULE(XMLSERVICE/PLUGCONF7) SRCFILE(XMLSERVICE/QRPGLESRC) +
  DBGVIEW(*SOURCE) OUTPUT(*PRINT) REPLACE(*YES)
...
CRTPGM PGM(ZNDSVRPHP7/XMLSERVICE) +
...
CRTPGM PGM(ZNDSVRPHP7/XMLVER) +
  MODULE(XMLSERVICE/XMLVER)

CRTPGM PGM(ZNDSVRPHP7/XMLCGI) +
...
DLTMOD MODULE(XMLSERVICE/PLUGCONF7)
...
QSH CMD('/usr/bin/db2 -t -f /qsys.lib/XMLSERVICE.lib/QSQLSRC.FILE/CRTSQL7.MBR')
