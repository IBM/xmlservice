--TEST--
XML i Toolkit: IBM_DB2 inout PGM - hex xml call pgm complex data
--SKIPIF--
...
$ctl .= " *hex *before(819/37) *after(37/819)";
$clobIn = bin2hex(getxml()); // doc-2-hexin
$doc = pack("H*", $clobIn); // hexout-2-doc
var_dump($doc);
$clobOut = "";
...
var_dump($clobOut);
$doc = pack("H*", $clobOut);  // hexout-2-doc
var_dump($doc);
$clobOut = $doc;
