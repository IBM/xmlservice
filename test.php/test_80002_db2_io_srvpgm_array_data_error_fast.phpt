--TEST--
XML i Toolkit: IBM_DB2 srvpgm error bad array element error fast
--SKIPIF--
...
if (strpos($clobOut,"<joblogscan>")>0) die("Error contains <joblogscan>, but should not error='fast'\n");
...
$clob = <<<ENDPROC
<?xml version='1.0'?>
<pgm name='ZZSRV' lib='xyzlibxmlservicexyz' func='ZZARRAY' error='fast'>
