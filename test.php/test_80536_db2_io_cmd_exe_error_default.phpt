--TEST--
XML i Toolkit: IBM_DB2 check cmd exe error default
--SKIPIF--
...
if (strpos($clobOut,"<error>CPF")>0) die("Error contains <error>CPFxxx</error>, but should not exec='cmd' (default)\n");
...
<?xml version='1.0'?>
<script>
<cmd exec='cmd'>ADDLIBLE LIB(QTEMP)</cmd>
<cmd exec='cmd'>ADDLIBLE LIB(QTEMP)</cmd>
</script>
ENDPROC;
return $clob;
