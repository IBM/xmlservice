--TEST--
XML i Toolkit: IBM_DB2 check cmd system error on
--SKIPIF--
...
if (strpos($clobOut,"<cpf>CPF")<1) die("Missing <cpf>CPFxxx</error>\n");
...
<?xml version='1.0'?>
<script>
<cmd exec='system' error='on'>ADDLIBLE LIB(QTEMP)</cmd>
<cmd exec='system' error='on'>ADDLIBLE LIB(QTEMP)</cmd>
</script>
ENDPROC;
return $clob;
