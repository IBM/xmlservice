--TEST--
XML i Toolkit: DOUEVIL1  check missing dou overlay bad data underneath error fast
--SKIPIF--
...
<script>
<pgm name='DOUEVIL1' error='fast'>
<parm prm='pm10000000aa'>
<data var='va10000000ab' type='3s0' enddo='v0cnt'>zz0cnt</data>
</parm>
<parm io='in' prm='pm20000000ba'>
<data var='va10000000ab' type='50000a'/>
</parm>
