--TEST--
XML i Toolkit: IBM_DB2 result set SRVPGM - array small data
--SKIPIF--
...
$stmt = db2_prepare($conn, "call $procLib.iPLUGR32K(?,?,?)");
...
$myMax1  = 1;         // expected max
$myCount1= 1;         // expected count
...
<pgm name='ZZSRV' lib='xyzlibxmlservicexyz' func='ZZARRAY'>
 ...
 <parm comment='max allowed return'>
  <data var='myMax' type='10i0'>1</data>
 </parm>
