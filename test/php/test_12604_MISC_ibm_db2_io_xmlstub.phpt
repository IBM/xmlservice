--TEST--
XML i Toolkit: IBM_DB2 inout sys api -  QWCRSSTS no xml values
--SKIPIF--
...
<pgm name='QWCRSSTS' lib='QSYS'>
 <parm io='both'>
  <ds>
   <data type='10i0' var='BYTES' comment='BYTES'/>
   <data type='10i0' var='RET' comment='RET'/>
   <data type='8B' var='DATE_TIME' comment='DATE_TIME'/>
   <data type='8A' var='SYSTEM' comment='SYSTEM'/>
   <data type='10i0' var='USERS' comment='USERS'/>
   <data type='10i0' var='DIS_USERS' comment='DIS_USERS'/>
   <data type='10i0' var='SUSP_JOBS' comment='SUSP_JOBS'/>
   <data type='10i0' var='JB_GP_SUSP' comment='JB_GP_SUSP'/>
   <data type='10i0' var='USER_SIGNED_PRINT_WAIT' comment='USER_SIGNED_PRINT_WAIT'/>
   <data type='10i0' var='MSG_WAIT' comment='MSG_WAIT'/>
   <data type='10i0' var='BATCH_JOBS' comment='BATCH_JOBS'/>
   <data type='10i0' var='HELD_BATCH' comment='HELD_BATCH'/>
   <data type='10i0' var='END_BATCH' comment='END_BATCH'/>
   <data type='10i0' var='WAITING_BATCH' comment='WAITING_BATCH'/>
   <data type='10i0' var='BATCH_HELD_ON_QUE' comment='BATCH_HELD_ON_QUE'/>
 ...
 <parm io='both'>
  <ds>
   <data type='10i0' var='provided' comment='provided'/>
   <data type='10i0' var='available' comment='available'/>
